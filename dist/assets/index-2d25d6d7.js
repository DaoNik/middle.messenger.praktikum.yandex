...
`;class Y extends g{constructor(){super(Z)}}const H=`<section class="auth login" id="{{blockId}}">
  ...
  <form class="auth__form" name="login" (submit)="onSubmit">
    ...
    <div class="auth__actions">
      ...
      <a class="auth__link" href="/register" (click)="onRedirect"
        >Нет аккаунта?</a
      >
    </div>
  </form>
</section>
`,J=o=>{o.preventDefault(),o.stopPropagation();const s=o.target;document.location.href=s.href};class j extends v{constructor(){super(H,[],{login_error:"",password_error:""},{onSubmit:n=>{n.preventDefault();const t=this.form;if(d(t)){const e={};for(const[a,l]of t.controls)e[a]=l.value;console.log(e)}},onInput:n=>{const t=this.form.controls,e=n.target;t.has(e.name)&&(t.get(e.name).value=e.value)},onBlur:n=>{var _;const t=this.form,e=n.target,a=t.controls.get(e.name),{isValid:l,error:r}=f(a);a.valid=l,a.error=r,this.props[`${e.name}_error`]!==a.error&&(this.props[`${e.name}_error`]=a.error),t.valid=d(t);const c=(_=this.element)==null?void 0:_.querySelector('button[type="submit"]');c&&(c.disabled=!t.valid)},onRedirect:J});i(this,"form",{controls:new Map([["login",{value:"",validators:[u,p],minLength:4,valid:!1,error:""}],["password",{value:"",validators:[u,p],minLength:6,valid:!1,error:""}]]),valid:!1});i(this,"selector","login-form")}}const K=`<section id="{{blockId}}">{{>login-form}}</section>
`;class G extends g{constructor(){super(K,[new j])}}const Q=`<section class="auth register" id="{{blockId}}">
...
`;class se extends v{constructor(){super(te,[],{email_error:"",login_error:"",first_name_error:"",second_name_error:"",phone_error:"",display_name_error:""},{onSubmit:n=>{n.preventDefault();const t=this.form;if(d(t)){const e={};for(const[a,l]of t.controls)e[a]=l.value;console.log(e)}},onInput:n=>{const t=this.form.controls,e=n.target;t.has(e.name)&&(t.get(e.name).value=e.value)},onBlur:n=>{var _;const t=this.form,e=n.target,a=t.controls.get(e.name),{isValid:l,error:r}=f(a);a.valid=l,a.error=r,this.props[`${e.name}_error`]!==a.error&&(this.props[`${e.name}_error`]=a.error),t.valid=d(t);const c=(_=this.element)==null?void 0:_.querySelector('button[type="submit"]');c&&(c.disabled=!t.valid)},onDialogClose:()=>{var n;(n=this.element)==null||n.classList.remove("overlay_opened")},onDialogNotClose:n=>{n.stopPropagation()}});i(this,"form",{controls:new Map([["email",{value:"",validators:[u,p,w],minLength:4,valid:!1,error:""}],["login",{value:"",validators:[u,p],minLength:4,valid:!1,error:""}],["display_name",{value:"",validators:[u,p],minLength:4,valid:!1,error:""}],["first_name",{value:"",validators:[u,p],minLength:4,valid:!1,error:""}],["second_name",{value:"",validators:[u,p],minLength:4,valid:!1,error:""}],["phone",{value:"",validators:[u,p,E],minLength:8,valid:!1,error:""}]]),valid:!1});i(this,"selector","change-user-data-dialog")}}const ae=`<div
...
`;class re extends v{constructor(){super(le);i(this,"selector","load-file-dialog")}}const ie=`<section class="profile" id="{{blockId}}">
...
`;class ce extends g{constructor(){super(ie,[new se,new oe,new re],{},{onChangeDataDialogOpened:()=>{document.querySelector(".overlay-change-data").classList.add("overlay_opened")},onChangePasswordDialogOpened:()=>{document.querySelector(".overlay-change-password").classList.add("overlay_opened")}})}}const ue=[{path:"/chats",component:z},{path:"/404",component:Y},{path:"/500",component:M},{path:"/login",component:G},{path:"/register",component:ne},{path:"/profile",component:ce}];let b=null;document.location.pathname==="/"&&(document.location.pathname="/login");for(const{path:o,component:s}of ue)o===document.location.pathname&&(b&&b.eventBus.emit(g.EVENTS.DESTROY),b=new s,document.querySelector("#root").innerHTML=b.content,b.eventBus.emit(g.EVENTS.FLOW_CDM));
